      ...
      if (isOnline) {
        ...
        if (j.billId) { 
          ...
          setLastBill({
            ...j,
            billNumber: j.billId,
            customerName: j.customerName || selectedCustomer?.name || 'Walk-in Customer',
            customerPhone: j.customerPhone || selectedCustomer?.phone || '',
            customerAddress: j.customerAddress || selectedCustomer?.address || '',
            ...
            <div class="invoice-content">
              ...
              <div class="summary" style="margin-top: 15px;">
                ...
                <div class="calc">
                  ${payments.map(p => `
                    <div class="calc-row">
                      <span class="calc-label">${p.method}:</span>
                      <span class="calc-value">₹${fmt1(p.amount)}</span>
                    </div>
                  `).join('')}
                  <div class="calc-row total">
                    <span class="calc-label">TOTAL PAID:</span>
                    <span class="calc-value">₹${fmt1(payments.reduce((s,p)=> s + (Number(p.amount)||0), 0))}</span>
                  </div>
                </div>
              </div>
              ` : ''}
